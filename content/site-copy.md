# Leon Portfolio: Site Copy

This file covers the home hero and bio, the About paragraph, and the short teaser copy for the projects grid. Case study detail copy lives in the separate case-study files.
...
**Optional education block (can live here or on the Experience page):**
...
Order is fixed as below. Each card shows a name, a one-line tagline that leads with the strongest fact, a short description, tags, a status, and action links.
...
### 2. Multi-Agent Software Development System
...
- **Status:** Active
- **Links:** GitHub · Built by the system: tab-vault.com
...
- **Status:** Active
- **Links:** Live: tab-vault.com · GitHub
